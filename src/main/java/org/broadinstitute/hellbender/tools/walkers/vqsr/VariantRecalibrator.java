...
public class VariantRecalibrator extends MultiVariantWalker {
    ...
    @Argument(fullName="tranches-file", shortName="tranchesFile", doc="The output tranches file used by ApplyRecalibration", optional=false)
    ...
    @Argument(fullName="rscript-file", shortName="rscriptFile", doc="The output rscript file generated by the VQSR to aid in visualization of the input data and learned model", optional=true)
